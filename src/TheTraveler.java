...
public class TheTraveler implements Jogo{
	...
	public TheTraveler(){
		ant = new Ant(50,getHeight()/4); //position
	...
	public void tecla(String c){
		...
		case 0:
			if(c.equals(" ")){
				auxtimer = new Timer(1.6, false, nextScene());
				nextScene().executa();
			}
			break;
		case 1:
	...
	public void toDraw(Scene t){
		...
		case 3:
			...
			t.texto("          Press Space to try again", 60, 160, 18, Colour.rgb(38,104,211));
			break;
		}		
	}
